...
class Trainer:
    def __init__(self,
        ...
        # Tracking the loss and accuracy metrics during the training and validation phases
        self.train_history = dict(
            loss=collections.OrderedDict(), #one loss dict for training
            accuracy=collections.OrderedDict() #one accuracy dict for training

        )
        self.validation_history = dict(
            loss=collections.OrderedDict(), #one loss dict for val
            accuracy=collections.OrderedDict() #one accuracy dict for val
        )
